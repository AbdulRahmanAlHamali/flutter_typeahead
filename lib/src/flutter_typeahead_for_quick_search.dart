...
///
/// ### Example 2:
/// Here's another example, where we use the TypeAheadFormFieldQuickSearch inside a `Form`:
/// ```dart
...
/// You provide this property with an instance of `QuickSearchTextFieldConfiguration`,
